...
Preload.prototype =  {
    ...
    preload: function() {
        ...
        game.load.audio('beethoven1', './resources/audio/beethoven1.mp3');
        game.fieldsAudio[1] = 'beethoven2';
        game.load.audio('beethoven2', './resources/audio/beethoven2.mp3');
        game.fieldsAudio[2] = 'grieg1';
        game.load.audio('grieg1', './resources/audio/grieg1.mp3');
        game.fieldsAudio[3] = 'grieg2';
        game.load.audio('grieg2', './resources/audio/grieg2.mp3');        
        game.fieldsAudio[4] = 'handel1';
        game.load.audio('handel1', './resources/audio/handel1.mp3');
        game.fieldsAudio[5] = 'handel2';
        game.load.audio('handel2', './resources/audio/handel2.mp3');
        game.fieldsAudio[6] = 'tchaikovsky1';
        game.load.audio('tchaikovsky1', './resources/audio/tchaikovsky1.mp3');
        game.fieldsAudio[7] = 'tchaikovsky2';
        game.load.audio('tchaikovsky2', './resources/audio/tchaikovsky2.mp3');
        game.fieldsAudio[8] = 'vivaldi1';
        game.load.audio('vivaldi1', './resources/audio/vivaldi1.mp3');
        game.fieldsAudio[9] = 'vivaldi2';
        game.load.audio('vivaldi2', './resources/audio/vivaldi2.mp3');
        game.fieldsAudio[10] = 'rossini1';
        game.load.audio('rossini1', './resources/audio/rossini1.mp3');
        game.fieldsAudio[11] = 'rossini2';
        game.load.audio('rossini2', './resources/audio/rossini2.mp3');
        game.finalAudio[0] = 'beethoven3';
        game.load.audio('beethoven3', './resources/audio/beethoven3.mp3'); 
        game.finalAudio[1] = 'grieg3';
        game.load.audio('grieg3', './resources/audio/grieg3.mp3');       
        game.finalAudio[2] = 'handel3';
        game.load.audio('handel3', './resources/audio/handel3.mp3'); 
        game.finalAudio[3] = 'tchaikovsky3';
        game.load.audio('tchaikovsky3', './resources/audio/tchaikovsky3.mp3'); 
        game.finalAudio[4] = 'vivaldi3';
        game.load.audio('vivaldi3', './resources/audio/vivaldi3.mp3'); 
        game.finalAudio[5] = 'rossini3';
        game.load.audio('rossini3', './resources/audio/rossini3.mp3');
